...
class CTitleLogo:public CScene
{
	//公開メンバ
	public:
		CTitleLogo(OBJTYPE nObjType,int nPriority =3);		//コンストラクタ
		~CTitleLogo();										//デストラクタ
		...
		static CTitleLogo* Create(float fPosX,float fPosY,float fSizeX,float fSizeY,char* TextureName,CRenderer* m_pRenderer,int nPriority =3);
